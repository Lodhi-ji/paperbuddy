      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight text-slate-800 flex items-center gap-1.5">
            Campus Pay <span className="text-xs bg-indigo-50 text-indigo-600 px-2 py-0.5 rounded-full border border-indigo-100 font-semibold">SaaS</span>
          </h1>
        ...
        <div className="glass-card rounded-3xl p-8 shadow-premium border border-white/30 relative">
          ...
          <div className="mt-8 pt-6 border-t border-slate-200/50">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <button
                type="button"
                onClick={() => handleQuickFill('superadmin@campuspay.com', 'SuperAdmin123!')}
