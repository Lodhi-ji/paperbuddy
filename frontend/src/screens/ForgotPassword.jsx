  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-[440px] z-10 flex flex-col items-center">
        ...
        {/* Large pulsing Logo Orb above the card */}
        <motion.div 
          animate={{ scale: [1, 1.03, 1] }}
          transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
          className="w-24 h-24 rounded-full bg-white border border-[#E5E7EB] shadow-[0_0_40px_rgba(255,255,255,0.15)] flex items-center justify-center overflow-hidden mb-6"
        >
          <div className="absolute inset-0.5 rounded-full bg-gradient-to-tr from-[#5B5CEB]/10 to-white blur-sm" />
          <img src="/campuspay-logo.png" alt="CampusPay" className="h-10 w-auto object-contain relative z-10 scale-[1.2] transform-gpu" />
        </motion.div>
        ...
        <motion.div 
          ...
          className="w-full bg-slate-900/40 backdrop-blur-xl border border-white/10 rounded-[28px] p-8 md:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] space-y-6 text-left"
        >
